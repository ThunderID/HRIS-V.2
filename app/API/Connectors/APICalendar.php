...
class APICalendar extends APIData
{
	...
	{
		$this->apiUrl 					= '/organisation'.'/'.$org_id.'/calendars';
	...
	{
		$this->apiUrl 					= '/organisation'.'/'.$org_id.'/calendar/store';
		$this->apiData 					= array_merge($this->apiData, ["calendar" => $data]);
	...
	{
		$this->apiUrl 					= '/organisation'.'/'.$org_id.'/calendar/' . $id;
	...
	{
		$this->apiUrl 					= '/organisation'.'/'.$org_id.'/calendar/delete/' . $id;
