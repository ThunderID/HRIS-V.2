...
Route::group(['namespace' => 'Org\\'], function()
{
	...
	Route::resource('/org/{org_id?}/policy',	'PolicyController',						['names' => ['index' => 'policy.index', 'create' => 'policy.create', 'store' => 'policy.store', 'show' => 'policy.show', 'edit' => 'policy.edit', 'update' => 'policy.update', 'destroy' => 'policy.destroy']]);
	...
	Route::any('org/{org_id?}/ajax/charts',											['uses' => 'ChartController@FindChartByOrganisation', 	'as' => 'ajax.organisation.charts']);
