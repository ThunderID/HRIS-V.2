 ...
 * 2. getDevice()						: detect client device, used in function generateView
 * 3. initPageAttributes() 				: initalize page attributes, used in function generateView, called on this class construct
 * 4. initPageDatas() 					: initalize page datas, used in function generateView, called on this class construct
 * 5. setPage() 						: get page from input, used in function setPageDataParameter
 * 6. setSearch() 						: get search parameter from input, used in function setPageDataParameter
 * 7. setFilter() 						: get filter parameter from input, used in function setPageDataParameter
 * 8. setSort() 						: get sort parameter from input, used in function setPageDataParameter
 */
