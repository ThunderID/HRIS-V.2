<div class="row">
	<div class="col-sm-12">
		<div class="padding-top-15 font-size-14 padding-bottom-10"><strong>Relasi</strong> <a href=""><i class="ion-ios-plus-outline"></i></a></div>
		@if(count($page_datas->datas['employee']['relatives']))
