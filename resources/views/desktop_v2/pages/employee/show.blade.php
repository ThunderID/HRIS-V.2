				...
				<div class="background-white">
					...
					<div class="row">
						<div class="col-sm-12 padding-left-30 padding-top-15 padding-right-15"> 
							...
							<div class="workspace mCustomScrollbar light _mCS_2 mCS-autoHide workspace-mini-desktop" data-mcs-theme="minimal-dark" style="overflow: visible;">
								<div class="mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside" style="max-height: none;" tabindex="0">
									<div class="mCSB_container" style="position: relative; left: 0px;" dir="ltr">
...
@section('js')
	<script type="text/javascript">
		...
		hris_set_workspace.miniDesktopResize();
