		...
		<div class="row">
			<div class="col-sm-12 padding-left-0 padding-right-0" >
				...
				<div class="background-blue height-50 padding-top-10 padding-left-15" style="float:left; width: calc(100% - 85px);">
					...
					<!-- main nav -->
					<a href="#" class="dropdown-toggle link-white font-size-16 padding-top-7 padding-right-15" style="float:right;" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{Session::get('whoami')['name']}}&nbsp;<i class="ion-android-contact"></i></a>
