<div class="container-second-nav padding-15">
	@if(isset($action_create_button))
		<a class="link-blue font-14" href="{{$action_create_button}}"><i class="ion-android-add"></i> Tambah Baru</a>
	@else
		...
		@endif
		<a href="{{route('branch.index')}}" class="link-blue padding-left-15 padding-right-15 padding-bottom-5"><i class="ion-android-close"></i>&nbsp;Batal</a>
	...
	@if(isset($action_edit_button))
		...
		<a class="link-blue font-14" href="javascript:void(0);" data-backdrop="static" data-keyboard="false" data-toggle="modal" 
				...
				data-effect="Menghapus cabang akan menghapus data struktur organisasi. Lanjutkan Menghapus ?"
