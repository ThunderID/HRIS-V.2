<ul class="dropdown-menu filter-menu filter-menu-employee modal-filter">
		...
		<li class="dropdown-item padding-top-10">
			<div class="row padding-bottom-10">
				...
				<div class="col-sm-4 border-left-1 padding-0">
					...
					<div class="workspace mCustomScrollbar light _mCS_2 mCS-autoHide modal-filter-fixed-height" data-mcs-theme="minimal-dark" style="overflow: visible;">
