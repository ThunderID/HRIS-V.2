...
Breadcrumb
==================================== -->
<div class="row padding-0 background-white margin-left-0"> 
	<div class="col-md-8 col-sm-12 padding-left-0"> 
	...
	<div class="col-md-4 hidden-sm-down {{(isset($padding_top_action) ? $padding_top_action : '')}} text-xs-right margin-left-negative-15"> 
	    @yield('action_area')
	</div>
