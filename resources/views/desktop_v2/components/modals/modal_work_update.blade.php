	 ...
	 <div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action="{{$modal_route}}" method="PATCH" class="modal_work_update">
					...
					<div class="row">
						<div class="col-sm-6">
							<fieldset class="form-group">
								...
								<input name="nik" class="form-control" id="employeenik" placeholder="Masukkan nik karyawan">
							</fieldset>
						</div>
						<div class="col-sm-6">
							<fieldset class="form-group">
					...
					<div class="row">
						<div class="col-sm-6">
							<fieldset class="form-group">
								...
								<input name="grade" class="form-control" id="employeeworkgrade" placeholder="Masukkan grade karyawan">
							</fieldset>
						</div>
						<div class="col-sm-6">
							<fieldset class="form-group">
								<label for="employeeworkstatus">Status Kerja</label>
								<input name="status" class="form-control" id="employeeworkstatus" placeholder="Masukkan status karyawan">
							</fieldset>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<fieldset class="form-group">
								...
								<input name="start" class="form-control" id="employeeworkstart" placeholder="Masukkan start karyawan">
							</fieldset>
						</div>
						<div class="col-sm-6">
							<fieldset class="form-group">
								<label for="employeeworkend">Tanggal Status Kerja Berakhir</label>
								<input name="end" class="form-control" id="employeeworkend" placeholder="Masukkan end karyawan">
							</fieldset>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
							<fieldset class="form-group">
								...
								<textarea name="employeeworkreason" class="form-control" id="employeeworkendreason">
								</textarea>
							</fieldset>
						</div>
					</div>
